...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Post.reply_count'
        db.alter_column(u'vkontakte_wall_post', 'reply_count', self.gf('django.db.models.fields.PositiveIntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'Post.reply_count'
        db.alter_column(u'vkontakte_wall_post', 'reply_count', self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True))
