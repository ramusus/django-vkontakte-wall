...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_index(u'vkontakte_wall_comment', ['fetched'])

        # Adding index on 'Post', fields ['fetched']
        db.create_index(u'vkontakte_wall_post', ['fetched'])


    def backwards(self, orm):
        # Removing index on 'Post', fields ['fetched']
        db.delete_index(u'vkontakte_wall_post', ['fetched'])

        # Removing index on 'Comment', fields ['fetched']
        db.delete_index(u'vkontakte_wall_comment', ['fetched'])
