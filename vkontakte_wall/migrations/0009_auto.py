...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Comment', fields ['wall_owner_id']
        db.create_index(u'vkontakte_wall_comment', ['wall_owner_id'])

        # Adding index on 'Comment', fields ['reply_for_id']
        db.create_index(u'vkontakte_wall_comment', ['reply_for_id'])

        # Adding index on 'Comment', fields ['likes']
        db.create_index(u'vkontakte_wall_comment', ['likes'])

        # Adding index on 'Comment', fields ['author_id']
        db.create_index(u'vkontakte_wall_comment', ['author_id'])

        # Adding index on 'Post', fields ['likes']
        db.create_index(u'vkontakte_wall_post', ['likes'])

        # Adding index on 'Post', fields ['copy_owner_id']
        db.create_index(u'vkontakte_wall_post', ['copy_owner_id'])

        # Adding index on 'Post', fields ['comments']
        db.create_index(u'vkontakte_wall_post', ['comments'])

        # Adding index on 'Post', fields ['author_id']
        db.create_index(u'vkontakte_wall_post', ['author_id'])

        # Adding index on 'Post', fields ['wall_owner_id']
        db.create_index(u'vkontakte_wall_post', ['wall_owner_id'])

        # Adding index on 'Post', fields ['reposts']
        db.create_index(u'vkontakte_wall_post', ['reposts'])


    def backwards(self, orm):
        # Removing index on 'Post', fields ['reposts']
        db.delete_index(u'vkontakte_wall_post', ['reposts'])

        # Removing index on 'Post', fields ['wall_owner_id']
        db.delete_index(u'vkontakte_wall_post', ['wall_owner_id'])

        # Removing index on 'Post', fields ['author_id']
        db.delete_index(u'vkontakte_wall_post', ['author_id'])

        # Removing index on 'Post', fields ['comments']
        db.delete_index(u'vkontakte_wall_post', ['comments'])

        # Removing index on 'Post', fields ['copy_owner_id']
        db.delete_index(u'vkontakte_wall_post', ['copy_owner_id'])

        # Removing index on 'Post', fields ['likes']
        db.delete_index(u'vkontakte_wall_post', ['likes'])

        # Removing index on 'Comment', fields ['author_id']
        db.delete_index(u'vkontakte_wall_comment', ['author_id'])

        # Removing index on 'Comment', fields ['likes']
        db.delete_index(u'vkontakte_wall_comment', ['likes'])

        # Removing index on 'Comment', fields ['reply_for_id']
        db.delete_index(u'vkontakte_wall_comment', ['reply_for_id'])

        # Removing index on 'Comment', fields ['wall_owner_id']
        db.delete_index(u'vkontakte_wall_comment', ['wall_owner_id'])
