...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Post.repost_users.through.time_from'
        db.add_column('vkontakte_wall_post_repost_users', 'time_from',
            self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True),
            keep_default=False)

        # Adding field 'Post.repost_users.through.time_to'
        db.add_column('vkontakte_wall_post_repost_users', 'time_to',
            self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True),
            keep_default=False)

    def backwards(self, orm):

        # Deleting field 'Post.repost_users.through.time_from'
        db.delete_column('vkontakte_wall_post_repost_users', 'time_from')

        # Deleting field 'Post.repost_users.through.time_to'
    ...
    models = {
        ...
        u'vkontakte_wall.post': {
            ...
            'repost_users': ('m2m_history.fields.ManyToManyHistoryField', [], {'related_name': "'repost_posts'", 'symmetrical': 'False', 'to': u"orm['vkontakte_users.User']"}),
