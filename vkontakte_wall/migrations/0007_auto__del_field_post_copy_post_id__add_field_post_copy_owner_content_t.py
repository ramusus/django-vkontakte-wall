...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Adding field 'Post.copy_post_id'
        db.add_column('vkontakte_wall_post', 'copy_post_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True),
                      keep_default=False)

        # Deleting field 'Post.copy_owner_content_type'
        db.delete_column('vkontakte_wall_post', 'copy_owner_content_type_id')

        # Deleting field 'Post.copy_post'
    ...
    models = {
        ...
        'vkontakte_wall.post': {
            ...
            'copy_post': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['vkontakte_wall.Post']"}),
