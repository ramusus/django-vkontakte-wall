...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('vkontakte_wall_comment', 'wall_owner_content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=ContentType.objects.all()[0].id, related_name='vkontakte_wall_comments', to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'Comment.wall_owner_id'
        db.add_column('vkontakte_wall_comment', 'wall_owner_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=1),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Comment.wall_owner_content_type'
        db.delete_column('vkontakte_wall_comment', 'wall_owner_content_type_id')

        # Deleting field 'Comment.wall_owner_id'
